// ──────────────────────────────────────────────────────────────────────────────
//  NAIRU model with two wage-growth series (ULC & AENA).
//  • Inflation equation uses ULC (series 1) as the wage-cost input.
//  • Wage block estimates separate observation equations for ULC and AENA.
...
data {
  int<lower=1> T;
  int<lower=1> J;
  matrix[T, J] Y;                      // cols: ULC, AENA, import, LUR, CPI, PIE, d1, d2, d3, d4
