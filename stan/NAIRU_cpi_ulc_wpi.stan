// ──────────────────────────────────────────────────────────────────────────────
//  NAIRU model with two wage-growth series (ULC & WPI).
//  • Inflation equation uses ULC (series 1) as the wage-cost input.
//  • Wage block estimates separate observation equations for ULC and WPI.
...
data {
  int<lower=1> T;
  int<lower=1> J;
  matrix[T, J] Y;                      // cols: ULC, WPI, import, LUR, CPI, PIE, d1, d2, d3, d4
